...
<meta name="description" content="Tutorials for the University Timetable Manager." />
...
<div id="container">
  ...
  <div id="content">
    ...
    <ul class="main">
      <li>
        <p><a href="01.php">Tutorial 1: The Basics</a><br />
        Downloading and importing data; getting the optimal solution.</p>
      </li>
      <li>
        <p><a href="02.php">Tutorial 2: Manual Manipulation</a><br />
        Drag and drop; right click.</p>
      </li>
      <li>
        <p><a href="03.php">Tutorial 3: Advanced Optimisation</a><br />
        What does optimal mean to you? Modifying criteria; using filters; inserting unavailibilities.</p>
      </li>
      <li>
        <p><a href="linux.php">Linux Tutorial</a><br />
        A super-brief guide to running the timetable manager in Unix-based operating systems.</p>
      </li>
      <li>
        <p><a href="mac.php">Mac Tutorial</a><br />
        A rough guide for running the timetable manager in OS X.</p>
      </li>
    </ul>
  </div>
</div>
